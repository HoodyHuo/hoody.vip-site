export default function(opts) {
  ...
  Opt.cool && document.addEventListener('scroll', coolScrollHandler)
  Opt.cool || document.addEventListener('scroll', simpleScrollHandler)
  ...
  function coolScrollHandler() {
    const wrapHeight = document.documentElement.clientHeight// $scroll_wrap.clientHeight
