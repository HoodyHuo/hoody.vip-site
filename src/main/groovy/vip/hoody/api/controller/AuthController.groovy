...
import vip.hoody.api.service.AuthService
import vip.hoody.api.service.UserService
...
//        currentUser.login(new UsernamePasswordToken(username, password));
    ...
    public ResponseData userRegister(@Valid User user,
        ...
        if (bindingResult.hasErrors()) {
            return new ResponseData(success: false, msg: bindingResult.getAllErrors().toString());
        }
