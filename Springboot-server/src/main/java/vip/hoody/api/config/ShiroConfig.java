...
import vip.hoody.api.domain.Permission;
import vip.hoody.api.domain.Role;
import vip.hoody.api.service.RequestMapService;
import vip.hoody.api.shiro.CustomRealm;
...
import vip.hoody.api.shiro.CustomSessionManager;
...
class ShiroConfig {
     ...
     */
    @Bean
    public CustomRealm customRealm(@Value("${spring.datasource.url}") String uploadDir,@Value("${spring.datasource.password}") String pwd) {
        System.out.println("-------------------"+pwd+"-------------------------" + uploadDir);
